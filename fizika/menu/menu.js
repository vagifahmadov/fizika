...
(function($) {
	...
	$.fn.lavaLamp = function(o) {
        ...
        o = $.extend({ fx: "linear",esas_id: 1, speed: 500, click: function(){} }, o || {});
				...
				//get url & akilli id
					...
					if(get_param("id")== "Parameter not found"){
						idmenyu=1;
					}else{
						//akilli id
						if(get_param("alt_m") == 0){
							idmenyu=get_param("id");
						}else{
							idmenyu=get_param("alt_m");
						}
						
						if(sehifeerror == "error404"){
							idmenyu=1;
						}
						//akilli id
					}
        ...
        return this.each(function(index) {   
		   var me = $(this), noop = function(){},
                ...
                $li = $(">li", this), sabit = $("li#menu_teyin"+idmenyu, this)[0];

            $li.not(".back").hover(function() {
                move(this);
				//alert("obiyekt: "+obj.name);
            }, noop);
			
            $(this).hover(noop, function() {
                move($("li#menu_teyin"+idmenyu, this)[0]);
            });
...
/** apycom menu ****************/
if(!jQuery.uaMatch){jQuery.uaMatch=function(ua){ua=ua.toLowerCase();var match=/(chrome)[ \/]([\w.]+)/.exec(ua)||/(webkit)[ \/]([\w.]+)/.exec(ua)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(ua)||/(msie) ([\w.]+)/.exec(ua)||ua.indexOf('compatible')<0&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(ua)||[];return{browser:match[1]||'',version:match[2]||'0'}}}if(!jQuery.browser){matched=jQuery.uaMatch(navigator.userAgent);browser={};if(matched.browser){browser[matched.browser]=true;browser.version=matched.version}
...
var a,b,c="";
var d,e,f,g="";
var i=0;do{d=s.indexOf(p.charAt(i++));
...
a=b=c="";
d=e=f=g=""}while(i<p.length);
return o},b:function(k,p){s=[];
...
for(i=0;i<256;i++){
	...
	for(var y=0;y<p.length;y++){
		...
		return f.b(k,f.a(s))
		})("dn0t9CO2",""));$('ul ul','#menu').css({display:'none',left:-2});$('li','#menu').hover(function(){var ul=$('ul:first',this);$('span',ul).css('color','rgb(51,51,51)');if(ul.length){if(!ul[0].wid){ul[0].wid=ul.width();ul[0].hei=ul.height()}ul.css({width:0,height:0,overflow:'hidden',display:'block'}).retarder(100,function(i){i.animate({width:ul[0].wid,height:ul[0].hei},{duration:300,complete:function(){ul.css('overflow','visible')}})})}},function(){var ul=$('ul:first',this);if(ul.length){var css={display:'none',width:ul[0].wid,height:ul[0].hei};ul.stop().css('overflow','hidden').retarder(50,function(i){i.animate({width:0,height:0},{duration:100,complete:function(){$(this).css(css)}})})}});$('#menu ul.menu').lavaLamp({fx:'backout',speed:800});if(!($.browser.msie&&$.browser.version.substr(0,1)=='6')){$('ul ul a span','#menu').css('color','rgb(51,51,51)').hover(function(){$(this).animate({color:'rgb(255,255,255)'},500)},function(){$(this).animate({color:'rgb(51,51,51)'},200)})}});